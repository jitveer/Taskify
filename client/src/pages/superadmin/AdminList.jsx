                                    ...
                                    <tr key={index} className="border-b border-slate-50 hover:bg-slate-50/50 transition duration-150 last:border-none">
                                        <td className="py-5 px-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-800 text-base">{admin.first_name}</p>
                            ...
                            <div key={index} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative group overflow-hidden">
                                ...
                                <div className="flex justify-between items-start mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-black text-slate-800 text-lg leading-tight">{admin.first_name}</h3>
                                            <p className="text-xs text-slate-400 font-bold uppercase tracking-wider mt-0.5">{admin.id}</p>
                                        </div>
                                    </div>
